...
```ts
import { useCreateUser, useGetProduct, useListProducts, useCreateReview } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser();

const { data, isPending, isSuccess, isError, error } = useGetProduct();
...
```js
import { createUser, getProduct, listProducts, createReview } from '@dataconnect/generated';
