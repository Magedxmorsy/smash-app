    ...
    <View style={styles.wrapper}>
      ...
      {isTournamentStarted && (
        <View style={styles.bannerContainer}>
          <Banner
            variant="info"
            message="This tournament has already started. You can only edit the location, date, time, and rules. Changes to location or date/time will notify all participants."
            dismissible={false}
          />
        </View>
      )}
