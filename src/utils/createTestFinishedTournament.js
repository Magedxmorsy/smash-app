  ...
  const testTournament = {
    ...
    matches: [
      // Semifinal 1
      {
        ...
        matchNumber: 1,
        team1: {
          player1: { firstName: 'Leo', lastName: 'Miguele', avatarUri: null, userId: userData.uid },
          player2: { firstName: 'John', lastName: 'Smith', avatarUri: null, userId: 'test_user_1' },
        },
        team2: {
          player1: { firstName: 'Mike', lastName: 'Davis', avatarUri: null, userId: 'test_user_4' },
          player2: { firstName: 'Emma', lastName: 'Wilson', avatarUri: null, userId: 'test_user_5' },
        },
        winningTeam: 'left',
      ...
      // Semifinal 2
      {
        ...
        matchNumber: 2,
        team1: {
          player1: { firstName: 'Abdullah', lastName: 'Gaber', avatarUri: null, userId: 'test_user_2' },
          player2: { firstName: 'Sarah', lastName: 'Johnson', avatarUri: null, userId: 'test_user_3' },
        },
        team2: {
          player1: { firstName: 'Chris', lastName: 'Brown', avatarUri: null, userId: 'test_user_6' },
          player2: { firstName: 'Lisa', lastName: 'Taylor', avatarUri: null, userId: 'test_user_7' },
        },
        winningTeam: 'left',
